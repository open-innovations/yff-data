export const icons = {
  "default": {
    "svg":
      '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-geo-alt-fill" viewBox="0 0 16 16"><path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" fill="currentColor" /></svg>',
  },
  "geo": {
    "svg":
  ...
  "geo-alt": {
    "svg":
      `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
        <circle cx="8" cy="6" r="4" fill-opacity="0"></circle>
        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" fill="currentColor" ></path>
      </svg>`,
  },
  "asterisk": {
    "iconAnchor": [20, 20],
  ...
  "chat-square": {
    "svg":
      '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-chat-square-fill" viewBox="0 0 16 16"><path d="M2 0a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2.5a1 1 0 0 1 .8.4l1.9 2.533a1 1 0 0 0 1.6 0l1.9-2.533a1 1 0 0 1 .8-.4H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" fill="currentColor" /></svg>',
  },
};
