...
!function (a) {
  ...
  function c(a, b) {
    return h(a, b || {}).then(function (b) {
      return b.getContext("2d").getImageData(0, 0, q.width(a), q.height(a))
        .data;
    });
  }
  function d(a, b) {
  ...
  function i(a, b, c) {
    ...
    function f(a, b) {
      ...
      return b instanceof Element
        ? Promise.resolve().then(c).then(d).then(e).then(f).then(function () {
          return b;
        })
        : b;
    }
    return c || !b || b(a)
      ? Promise.resolve(a).then(d).then(function (c) {
        return e(a, c, b);
      }).then(function (b) {
        return f(a, b);
      })
  ...
  function l(a, b, c) {
    return Promise.resolve(a).then(function (a) {
      ...
      return '<foreignObject x="0" y="0" width="100%" height="100%">' + a +
        "</foreignObject>";
    }).then(function (a) {
  ...
  function m() {
    function a() {
      var a = "application/font-woff", b = "image/jpeg";
      return {
        woff: a,
        woff2: a,
    ...
    function j(a) {
      var b = 3e4;
      return v.impl.options.cacheBust &&
    ...
    function p(a) {
      var b = r(a, "border-left-width"), c = r(a, "border-right-width");
      return a.scrollWidth + b + c;
    }
    function q(a) {
      var b = r(a, "border-top-width"), c = r(a, "border-bottom-width");
  ...
  function n() {
    ...
    function d(d, e, f) {
      ...
      return g()
        ? Promise.resolve(d)
        : Promise.resolve(d).then(b).then(function (a) {
  ...
  function o() {
    ...
    function b() {
      ...
      return Promise.resolve(q.asArray(document.styleSheets)).then(b).then(a)
        .then(function (a) {
          return a.map(c);
        });
    }
  ...
  function p() {
    function a(a) {
      function b(b) {
        return q.isDataUrl(a.src)
          ? Promise.resolve()
          : Promise.resolve(a.src).then(b || q.getAndEncode).then(function (b) {
    ...
    function b(c) {
      ...
      return c instanceof Element
        ? d(c).then(function () {
          return c instanceof HTMLImageElement ? a(c).inline() : Promise.all(
